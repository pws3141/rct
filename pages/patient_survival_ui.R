layout_sidebar(
  sidebar = sidebar(
    #title = "How long might the patient survive?",
    ...
    actionButton("psurv_factors", "Show factors considered but not included",
                 icon = icon("info"), 
    ...
    actionButton("psurv_reset", "Reset all",
                 icon = icon("redo"), 
  ...
  # Main content area
  # Informational text
  h2("How long might you survive after a transplant from a deceased donor?"),
